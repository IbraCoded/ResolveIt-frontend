      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/register" className="text-muted-foreground hover:text-blue-600 transition-colors">
                  Create Account
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/dashboard" className="text-muted-foreground hover:text-blue-600 transition-colors">
                  Dashboard
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li className="text-muted-foreground">Family Mediation</li>
              <li className="text-muted-foreground">Business Disputes</li>
              <li className="text-muted-foreground">Criminal Cases</li>
              <li className="text-muted-foreground">Virtual Sessions</li>
              <li className="text-muted-foreground">Agreement Generation</li>
            </ul>
          </div>
        ...
        <div className="border-t mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">© 2025 ResolveIt. All rights reserved.</p>
